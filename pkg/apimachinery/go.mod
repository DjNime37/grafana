...
require (
	...
	github.com/grafana/authlib v0.0.0-20260407141039-e337d5a0c7df // @grafana/identity-access-team
	github.com/grafana/authlib/types v0.0.0-20260407141039-e337d5a0c7df // @grafana/identity-access-team
